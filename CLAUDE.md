...
- **Phase 1.5 (현재)**: 실제 StrategyCard(AI #2) 생성 완료, LightGBM AUC 0.742 + CNN AUC 0.766, Multi-Agent Debate 구현 완료, Conformal runtime 연결 완료, O-I Decoupling v1 (overnight 9-fold avg 0.527, max 0.616), 거래세/슬리피지 반영 백테스트 (Sharpe 1.69), feature_flags.yaml 도입
